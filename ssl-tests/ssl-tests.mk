...
ssl-tests-run-jks: $(SSLTESTS_CLASSES_DIR) $(KEYSTORE_JKS) $(TRUSTSTORE_JKS) $(SSLTESTS_NSSDB_DEP)
	$(JAVA) -cp $< \
	-Djavax.net.ssl.keyStore=$(KEYSTORE_JKS) \
	-Djavax.net.ssl.keyStorePassword=$(KEYSTORE_PASSWORD) \
	-Djavax.net.ssl.trustStore=$(TRUSTSTORE_JKS) \
	-Djavax.net.ssl.trustStorePassword=$(TRUSTSTORE_PASSWORD) \
	$(SSLTESTS_ONLY_SSL_DEFAULTS_PARAM) $(SSLTESTS_SSL_CONFIG_FILTER_PARAM) $(SSLTESTS_IGNORE_PROTOCOLS_PARAM) $(SSLTESTS_IGNORE_CIPHERS_PARAM) $(SSLTESTS_USE_OPENSSL_CLIENT_PARAM) $(SSLTESTS_USE_GNUTLS_CLIENT_PARAM) $(SSLTESTS_USE_NSS_CLIENT_PARAM) \
	$(SSLTESTS_CUSTOM_JAVA_PARAMS) \
	$(SSLTESTS_MAIN_CLASS)

ssl-tests-run-nss: $(SSLTESTS_CLASSES_DIR) $(JAVA_PKCS11_FIPS_SECURITY_CFG) $(SSLTESTS_NSSDB_DEP)
	$(JAVA) -cp $< \
